...
inline SSRETCODE _CryptGetKeyLens(LONG cbitSig, LONG* pcbPrivate, LONG* pcbPublic)
{
    return SSRETCODE();
}
inline SSRETCODE _CryptKeyGen(LONG cbRandom, LPVOID pvRandom, LONG cbitsSig, LPVOID pvKeyPrivate, LPVOID pvKeyPublic)
{
    return SSRETCODE();
}
inline SSRETCODE _CryptSign(LONG cbRandom, LPVOID pvRandom, LONG cbMsg, LPVOID pvMsg, LONG cbKeyPrivate, LPVOID pvKeyPrivate, LONG cbKeyPublic, LPVOID pvKeyPublic, LONG cbitsSig, LPVOID pvSig)
{
    return SSRETCODE();
}
inline SSRETCODE _CryptSignBatch(LONG cbRandom, LPVOID pvRandom, LONG cbMsg, LPVOID pvMsg, LONG cbKeyPrivate, LPVOID pvKeyPrivate, LONG cbKeyPublic, LPVOID pvKeyPublic, LONG cbitsSig, LPVOID pvSig, LONG cMsg)
{
    return SSRETCODE();
}
inline SSRETCODE _CryptAuthenticate(LONG cbMsg, LPVOID pvMsg, LONG cbKeyPrivate, LPVOID pvKeyPrivate, LONG cbKeyPublic, LPVOID pvKeyPublic, LONG cbitsSig, LPVOID pvSig)
{
    return SSRETCODE();
}inline SSRETCODE _CryptVerifySigFast(LONG cbMsg, LPVOID pvMsg, LONG cbKeyPublic, LPVOID pvKeyPublic, LONG cbitsSig, LPVOID pvSig)
{
    return SSRETCODE();
}
inline SSRETCODE _CryptVerifySig(LONG cbMsg, LPVOID pvMsg, LONG cbKeyPublic, LPVOID pvKeyPublic, LONG cbitsSig, LPVOID pvSig)
{
    return SSRETCODE();
}